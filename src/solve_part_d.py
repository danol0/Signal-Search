...
plt.plot(x, numba.pdf(x, *theta), label="Total")
plt.plot(x, f * numba.signal_pdf(x, mu, sg), label="Signal (scaled by f)", linestyle="--")
plt.plot(x, (1 - f) * numba.background_pdf(x, lam), label="Background (scaled by 1-f)", linestyle="--")
